...
public class CarControllerTest {
     ...
     *  Mockito Verify methods are used to check that certain behavior happened. We can use Mockito
        verify methods at the end of the testing method code to make sure that specified
        methods are called
     */
    @Test
    public void listCars() throws Exception {
        ...
        mvc.perform(get(new URI("/cars"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$._embedded.carList[*].details.model")
                        .value(car.getDetails().getModel()))
                .andExpect(MockMvcResultMatchers.jsonPath("$._embedded.carList[*].details.manufacturer.name")
    ...
    public void updateCar() throws Exception {
        Car car = getCar();
        car.getDetails().setBody("hatchback");
